...
from Train_Unet.data_prep.make_dataset import dataset_processing
from SegGan.experiment.experiment import create_model
import argparse
...
def main():
    ...
    if args.model_path:
        model = create_model(num_classes, batch_size, lr, iter(dls[0]).next()[0][0].unsqueeze(0), src,
